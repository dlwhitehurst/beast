...
dnf_install "vi make curl telnet openssl bind-utils diffutils python git jq procps nano traceroute iputils iproute"
...
buildah config --label name=beast-buildtools ${container}
