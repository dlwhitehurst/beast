...
kubeadm init --token=${TOKEN} --apiserver-advertise-address=192.168.1.100 --kubernetes-version=v1.24.0 --pod-network-cidr=10.244.0.0/16 >> /root/kubeinit.log 2>/dev/null
